    ...
    <div>
        <div className="max-w-9/10 lg:max-w-3/4 grid md:grid-cols-2 grid-cols-1 gap-4 mx-auto mt-12">
            <div className="flex-col space-y-4">
                <Heading size="2xl" variant="drop-shadow-lg">React UI components with pre-styled classes. open source</Heading>
        ...
        <div className="px-1 md:px-5 mx-auto md:grid sm:flex sm:flex-col md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mb-24 max-md:gap-y-8 md:gap-2">
            <div className="">
                <Card style="">
